//
//  EducationalProductViewController.swift
//  E-detailer
//
...
class EducationalProductViewController:  UIViewController,CLLocationManagerDelegate{
    ...
    @IBAction func BTNSelectDoctor(_ sender: Any) {
        self.performSegue(withIdentifier: "SendToEduDoctorScreen", sender: self)
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if id == "SendToEduDoctorScreen" {
            
            if ((destination as! EduDoctorViewController).delegate3 == nil) {

                (destination as! EduDoctorViewController).delegate3 = ({( doctorList: [DoctorResult]) in
...
//                    self.currentCall.
                    ...
                    self.currentCall?.Activity = "Educational Activity"
            ...
            if ((destination as! EduDoctorViewController).delegate4 == nil) {


                (destination as! EduDoctorViewController).delegate4 = ({( doctorList: [Msrplan]) in
        ...
        } else if  id == "SendToEduAddPatient"  {
            let patientController = destination as! EducationalActivityViewController
    ...
    @IBAction func onPressedLastSync(_ sender: Any) {
        ...
        self.performSegue(withIdentifier: "SendToEduCallListenerScreen", sender: self)
    }
