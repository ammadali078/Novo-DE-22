...
class EducationalActivityViewController: UIViewController,BEMCheckBoxDelegate, UIPickerViewDelegate, UIPickerViewDataSource, UITextFieldDelegate {
...
//        currentCall?.clinicActivity![index].patientConsentAttachmentUrl = imagePath
    ...
    //
        ...
        CommonUtils.showMsgDialog(showingPopupOn: self, withTitle: "Sante DCR", withMessage:"successfully submitted")
